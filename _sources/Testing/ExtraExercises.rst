...
.. activecode:: ee_inheritance_02
   ...
   class myTests(TestCaseGui):
      ...
      def testOneA(self):
         self.assertEqual(poutput, True, "Testing that output is assigned to correct value.")
...
.. activecode:: ee_inheritance_03
   ...
   class myTests(TestCaseGui):
      ...
      def testOneA(self):
         self.assertEqual(exp, [2.71828182846, 7.38905609893, 20.0855369232, 54.5981500331, 148.413159103], "Testing that exp is assigned to correct values.")
   myTests().main()
